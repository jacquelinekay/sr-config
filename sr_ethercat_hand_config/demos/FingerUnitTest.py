...
rospy.init_node('finger_unit_test')
c = Commander()
...
max_range = {"THJ2": 20, "THJ3": 12, "THJ4": 70, "THJ5": 0,
	     ...
	     "LFJ0": 180, "LFJ3": 90, "LFJ4": 20, "LFJ5": 1,
	     "WRJ1": 10, "WRJ2": 5,
...
def secuence_mf():
   ...
   while not rospy.is_shutdown():
      if time.time() > wake_time:
         ...
         counter = counter + 1
         print "\nPosition", counter
         print "LFJO:", rand_pos['LFJ0']
         print "LFJ3:", rand_pos['LFJ3']
         print "LFJ4:", rand_pos['LFJ4']
         print "Interpolation time:", rand_pos['interpolation_time']
         run_time = time.time() - start_time
         print "Run time:", run_time, "seconds"

         rospy.sleep(1.5)
         wake_time = time.time() + rand_pos['interpolation_time']*1.0
